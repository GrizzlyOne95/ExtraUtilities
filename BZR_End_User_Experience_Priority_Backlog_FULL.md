# BZR End-User Experience Priority Backlog

This artifact preserves the full original source entries, reordered by likely end-user experience impact. Original item numbers are retained in each priority entry.

Note: the source numbering skips original #35 and #40.

## Original global notes

```text
NOTICE: Anything gated with a variable or boolean to be enabled should always default to "on" so we can verify it works and doesn't causes crashes or issues. Having a flag is fine but everything in the patch should default to on. 

At anytime if a feature isn't clear or understood you should reference to the decompiled 1.5 and Redux codebase. 

Cleaning up: We should have all Shim and EXU logs route to a dedicated logs folder in the BZR directory instead of flooding root directory. 

Battlezone98Redux was compiled in Visual Studio 2013 32 bit.
```

## Tier 1 — Crash prevention, desync prevention, and broad stability
...
## Tier 2 — Mission-breaking and highly visible gameplay correctness

### Priority 16 — Original #55
...
## Tier 3 — Camera, controls, HUD, readability, and shell user experience

### Priority 33 — Original #56
...
## Tier 4 — Multiplayer/mod compatibility and creator-facing features with player-visible payoff

### Priority 50 — Original #15
...
## Tier 5 — Visual/rendering polish and presentation upgrades

### Priority 60 — Original #60
...
## Tier 6 — Already-implemented helpers, lower-risk fixes, or high-risk exploratory work

### Priority 76 — Original #9
