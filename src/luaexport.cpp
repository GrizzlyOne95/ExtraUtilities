...
namespace ExtraUtilities::Lua
{
	...
	extern "C" int __declspec(dllexport) luaopen_exu(lua_State* L)
	{
		...
		const luaL_Reg exuExports[] = {
			...
			{ "RestoreAllHudSprites", &ControlPanel::RestoreAllHudSprites },
			...
			{ "GetSkyBoxEnabled", &Environment::GetSkyBoxEnabled },
			{ "SetSkyBoxEnabled", &Environment::SetSkyBoxEnabled },
			{ "SetSkyBox", &Environment::SetSkyBox },
			{ "GetSkyDomeEnabled", &Environment::GetSkyDomeEnabled },
			{ "SetSkyDomeEnabled", &Environment::SetSkyDomeEnabled },
			{ "SetSkyDome", &Environment::SetSkyDome },
			{ "GetSkyPlaneEnabled", &Environment::GetSkyPlaneEnabled },
			...
			{ "SetParticleSystemDirection", &Environment::SetParticleSystemDirection },
			{ "SetParticleSystemEmitting", &Environment::SetParticleSystemEmitting },
			{ "SetParticleSystemVisible", &Environment::SetParticleSystemVisible },
			{ "SetParticleSystemSpeedFactor", &Environment::SetParticleSystemSpeedFactor },
			{ "SetParticleSystemKeepLocalSpace", &Environment::SetParticleSystemKeepLocalSpace },
			{ "SetParticleSystemMaterial", &Environment::SetParticleSystemMaterial },
			{ "SetParticleSystemRenderQueueGroup", &Environment::SetParticleSystemRenderQueueGroup },
			{ "SetParticleSystemParticleQuota", &Environment::SetParticleSystemParticleQuota },
			{ "SetParticleSystemDefaultDimensions", &Environment::SetParticleSystemDefaultDimensions },
			{ "SetParticleSystemNonVisibleUpdateTimeout", &Environment::SetParticleSystemNonVisibleUpdateTimeout },
			{ "AttachParticleSystemToCamera", &Environment::AttachParticleSystemToCamera },
			{ "AttachParticleSystemToObject", &Environment::AttachParticleSystemToObject },
			{ "AttachParticleSystemToBone", &Environment::AttachParticleSystemToBone },
			{ "DetachParticleSystem", &Environment::DetachParticleSystem },
			{ "UpdateParticleFollowers", &Environment::UpdateParticleFollowers },
			{ "GetParticleSystemEmitterCount", &Environment::GetParticleSystemEmitterCount },
			{ "GetParticleEmitterEmissionRate", &Environment::GetParticleEmitterEmissionRate },
			{ "SetParticleEmitterEnabled", &Environment::SetParticleEmitterEnabled },
			{ "SetParticleEmitterEmissionRate", &Environment::SetParticleEmitterEmissionRate },
			{ "SetParticleEmitterDirection", &Environment::SetParticleEmitterDirection },
			{ "SetParticleEmitterPosition", &Environment::SetParticleEmitterPosition },
			{ "SetParticleEmitterVelocity", &Environment::SetParticleEmitterVelocity },
			{ "SetParticleEmitterAngle", &Environment::SetParticleEmitterAngle },
			{ "SetParticleEmitterTimeToLive", &Environment::SetParticleEmitterTimeToLive },
			{ "SetParticleEmitterColor", &Environment::SetParticleEmitterColor },
			{ "GetParticleEmitterType", &Environment::GetParticleEmitterType },
			{ "GetParticleEmitterParameterNames", &Environment::GetParticleEmitterParameterNames },
			{ "GetParticleEmitterParameter", &Environment::GetParticleEmitterParameter },
			{ "SetParticleEmitterParameter", &Environment::SetParticleEmitterParameter },
			{ "GetParticleSystemAffectorCount", &Environment::GetParticleSystemAffectorCount },
			{ "GetParticleAffectorType", &Environment::GetParticleAffectorType },
			{ "GetParticleAffectorParameterNames", &Environment::GetParticleAffectorParameterNames },
			{ "GetParticleAffectorParameter", &Environment::GetParticleAffectorParameter },
			{ "SetParticleAffectorParameter", &Environment::SetParticleAffectorParameter },
			...
			{ "GetLightingMode", &Environment::GetLightingMode },
			...
			{ "SetMaterialTextureScroll", &GameObject::SetMaterialTextureScroll },
			{ "SetMaterialTextureRotate", &GameObject::SetMaterialTextureRotate },
			{ "SetMaterialTextureScrollAnimation", &GameObject::SetMaterialTextureScrollAnimation },
			{ "SetMaterialTextureRotateAnimation", &GameObject::SetMaterialTextureRotateAnimation },
			{ "GetTerrainMaterialName", &GameObject::GetTerrainMaterialName },
			{ "SetTerrainTextureSet", &GameObject::SetTerrainTextureSet },
			...
			{ "GetConstructionRigSelectionInfo", &GameObject::GetConstructionRigSelectionInfo },
			...
			{ "SetAiTargetSelectEnabled", &Patches::SetAiTargetSelectEnabled },
			{ "GetAiTargetSelectEnabled", &Patches::GetAiTargetSelectEnabled },
			{ "SetAiTargetScoringEnabled", &Patches::SetAiTargetScoringEnabled },
